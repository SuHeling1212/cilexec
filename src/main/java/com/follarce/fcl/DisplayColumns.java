...
/** Unicode-aware display-column measurement shared by FCL formatting and terminal adapters. */
public final class DisplayColumns {
    private DisplayColumns() { }

    /** Counts visible columns while ignoring ANSI CSI formatting sequences. */
