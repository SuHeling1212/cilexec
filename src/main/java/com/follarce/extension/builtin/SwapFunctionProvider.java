...
import com.follarce.kernel.effect.EffectLedger;
 ...
 * 命名空间: "swapPool"
 */
public class SwapFunctionProvider extends BuiltinFunctionProvider {
    ...
    public EffectPolicy getEffectPolicy(String functionName) {
        ...
        return super.getEffectPolicy(functionName);
    }
